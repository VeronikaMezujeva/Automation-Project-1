...
describe.skip('Section 1: Functional tests', () => {
    ...
    it('User can use only same both first and validation passwords', () => {
        ...
        cy.get('#email').type('lauraliis@test.com')
        cy.get('[placeholder="John"]').type('LauraLiis')
        cy.get('[data-testid="lastNameTestId"]').type('Lill')
    ...
    it('User can submit form with all fields added', () => {
        ...
        cy.get('#username').type('Something2')
        cy.get('#email').type('lauraliis@test.com')
        cy.get('[placeholder="John"]').type('LauraLiis')
        cy.get('[data-testid="lastNameTestId"]').type('Lill')
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        ...
        cy.get('[name="confirm"]').type('Password567')
        cy.get('h2').contains('Password').click()
        cy.get('.submit_button').should('be.enabled')
    ...
    it('User can not submit form if username is not filled in', () => {
        // Add at least 1 test for checking some mandatory field's absence
        cy.get('#username').type('NewUser')
        cy.get('#email').type('newuser@gmail.com')
        cy.get('[name="name"]').type('Sandra')
        cy.get('[name="lastName"]').type('Aarna')
        cy.get('[data-testid="phoneNumberTestId"]').type('555222999')
        cy.get('[name="password"]').type('radar')
        cy.get('[name="confirm"]').type('radar')
    ...
    it('User can not submit form if email is not filled in', () => {
...
describe('Section 2: Visual tests', () => {
    ...
    it('My test for second picture', () => {
        ...
        cy.get('[data-cy="cypress_logo"]').invoke('width').should('be.lessThan', 117).and('be.greaterThan', 90)
    });
